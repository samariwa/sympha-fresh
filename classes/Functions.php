...
class Functions{
    ...
    public static function genRandomSaltString() 
    {
        $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
   ...
   public function total_views($connection, $page_id = null)
 {
   if($page_id === null)
   {
 ...
 public function is_unique_view($connection, $visitor_ip, $page_id)
 {
 ...
 public function add_view($connection, $visitor_ip, $page_id)
 {
 ...
 public function page_views($page_id)
 {
     require('config.php');
 ...
 public function text_limit($x, $length)
 {
   if(strlen($x)<=$length)
   {
     echo $x;
