                                ...
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-details">
                                        <li>
                                            ...
                                            <span class="desc"><?php echo Config::get('organization_details/physical_address'); ?></span>
                                        </li>
                                        <li>
                                            <span class="title">Phone</span>
                                            <span class="desc"><?php echo Config::get('organization_details/contact'); ?> - Office <br> <?php echo Config::get('organization_details/contact'); ?> - Mobile</span>
                                        </li>
                                        <li>
                                ...
                                <div class="input-item">
                                    ...
                                    <div>
                                        ...
                                        if (Session::loggedIn() == TRUE)
                                        {
                                            ?>
                                            <input type="hidden" class="contact_page_token" id="token" name="token">
                                            <input type="hidden" name="hidden_email" id="hidden_email" value="<?php echo Session::get('email'); ?>">
                                            <div class="input-item">
