  ...
  <!-- Page Heading -->
     ...
     <div class="row">
      <div class="col-10 offset-1">
        <h6 class="col-10 offset-2">To print credit note, enter deliverer's name and click the 'Print button'.</h6><br>
        </div>
     </div>
        <div class="row">
      ...
      <div class="input-group-prepend" style="margin-left: 350px;" >
       ...
       <div class="col-5">
       <input type="date"  class="form-control col-6" name="creditDate" id="creditDate" value="" aria-describedby="inputGroup-sizing-default" <?php if ($view == 'Stores Supervisor') { ?> disabled <?php } ?> required autocomplete="date" autofocus style="font-family: FontAwesome, Arial; font-style: normal;">
        </div>
        </div><br>
        <div class="row">
