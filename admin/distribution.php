  ...
  <!-- Page Heading -->
     ...
     <div class="row">
      <div class="col-10 offset-1">
        <h6 class="col-10 offset-1">To print tomorrow's distribution list, enter deliverer's name and click the 'Print button'. Otherwise include point in time from which the distribution list should be printed.</h6><br>
        </div>
     </div>
        <div class="row">
        ...
        <div class="row">
         ...
         <input type="text" class="form-control col-12" aria-label="Default" aria-describedby="inputGroup-sizing-default" style="font-family: FontAwesome, Arial; font-style: normal;"  name="time" id="distributionTime">
       </div>
       </div>
        </div><br>
