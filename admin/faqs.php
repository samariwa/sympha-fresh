        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST">
                 <div class="row">
                 <textarea name="question" id="question" class="form-control col-9" style="padding:15px;margin-left: 60px" placeholder="Question..." required></textarea>
                  </div>
                  <br>
                  <div class="row">
                 <textarea name="answer" id="answer" class="form-control col-9" style="padding:15px;margin-left: 60px" placeholder="Answer..." required></textarea>
                  </div>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST">
                                    <div class="row">
                                        <textarea name="question" id="question<?php echo $id; ?>" class="form-control col-9" style="padding:15px;margin-left: 60px" placeholder="Question..." required><?php echo $question; ?></textarea>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <textarea name="answer" id="answer<?php echo $id; ?>" class="form-control col-9" style="padding:15px;margin-left: 60px" placeholder="Answer..." required><?php echo $answer; ?></textarea>
                                    </div>
                                    <br>
                                <div class="modal-footer">
